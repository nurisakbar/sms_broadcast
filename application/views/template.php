        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg">SMS BROADCAST</span>
                </a>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        foreach ($main_menu->result() as $main) {
                            ...
                            $sub_menu = $this->db->get_where('tabel_menu', array('is_main_menu' => $main->id,'publish'=>1));
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <?php
                        echo form_open('member/export_excel');
                        ?>
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myModalLabel"> Silahkan Pilih Data <?php echo form_dropdown('tipe',array('sudah beli'=>'SUDAH PERNAH BELI','belum beli'=>'BELUM PERNAH BELI'),'',"class='form-control'");?></h4>
                        </div>
                        <div class="modal-body">
                            <table class="table table-bordered">
                                ...
                                //foreach ($product as $p) {
                                    //echo "<tr><td><input type='checkbox' value='$p->product_id' name='product[]'> " . $p->nama . "</td></tr>";
                                //}
                                ?>
